...
class TestUtils:
    ...
    def test_validate_ref_value(self):
        ...
        assert validate_ref_value("1.0 amu", u.dimensions.mass) == 1.0 * u.Unit("amu")
    ...
    def test_target_box_two_constraint_number_density(self):
        ...
        assert np.allclose(ortho_box[2].value, cubic_box[0].value * 4, atol=1e-5)
    ...
    def test_calculate_box_length_fixed_l_1d(self):
        ...
        box_length = _calculate_box_length(mass=mass, density=density, fixed_L=fixed_L)
